...
ansible-playbook /home/ubuntu/insecure-python-microservice/infrastructure/ansible/master.yaml
ansible-playbook /home/ubuntu/insecure-python-microservice/infrastructure/ansible/worker.yml 
EOF
